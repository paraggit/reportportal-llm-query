...
class QueryValidator:
    ...
    def validate_query(query: str) -> Tuple[bool, Optional[str]]:
        ...
        if len(query) < QueryValidator.MIN_QUERY_LENGTH:
            return False, f"Query too short. Minimum {QueryValidator.MIN_QUERY_LENGTH} characters required"
        
        if len(query) > QueryValidator.MAX_QUERY_LENGTH:
            return False, f"Query too long. Maximum {QueryValidator.MAX_QUERY_LENGTH} characters allowed"
        ...
        return True, None#### `src/llm_integration/embeddings_manager.py`
```python
from typing import List, Dict, Any, Optional, Tuple
import numpy as np
